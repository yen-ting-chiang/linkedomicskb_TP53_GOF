################################################################################
# TP53 Phosphoprotein GSEA Results Summarization (LinkedOmicsKB Version)
#
# Aggregates the results from the fgsea analysis (phosphoprotein_GSEA_without_protein_normalization)
#
...
#
# Outputs: .csv and .xlsx files saved into phosphoprotein_GSEA_without_protein_normalization folder.
################################################################################
...
gsea_dir <- file.path(base_path, "phosphoprotein_GSEA_without_protein_normalization")
...
cat("====================================================================\n")
cat("TP53 Phosphoprotein GSEA Summarization (LinkedOmicsKB - without protein normalization)\n")
cat("====================================================================\n\n")
