...
#
# This script filters the KSEA summary results (without protein normalization)
# to identify kinases associated with GOF (Gain of Function) activity.
#
# Filtering Logic:
...
cat("====================================================================\n")
cat("TP53 Phosphoprotein KSEA - GOF Specific Extraction (without protein normalization)\n")
cat("====================================================================\n\n")
