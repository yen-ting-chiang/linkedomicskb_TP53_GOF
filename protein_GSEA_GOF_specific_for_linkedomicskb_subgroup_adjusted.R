...
#
# Reads the Detailed_Pathway_Summary files from the protein_GSEA_subgroup_adjusted folder.
...
#
# Outputs: .csv and .xlsx files saved into protein_GSEA_subgroup_adjusted folder.
################################################################################
...
gsea_dir <- file.path(base_path, "protein_GSEA_subgroup_adjusted")
...
if (!dir.exists(gsea_dir)) {
    stop("GSEA directory not found. Please make sure protein_GSEA_subgroup_adjusted exists.")
}
