...
#
# Aggregates the results from the fgsea analysis (phosphoprotein_GSEA_without_protein_normalization_subgroup_adjusted)
#
...
#
# Outputs: .csv and .xlsx files saved into phosphoprotein_GSEA_without_protein_normalization_subgroup_adjusted folder.
################################################################################
