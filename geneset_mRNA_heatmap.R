################################################################################
# Gene Set mRNA Polar Heatmap (Circular Heatmap)
#
# Purpose:
#   Visualize mRNA-level DEG results (logFC) for genes within specified
...
#
# Input:
#   - mRNA_differential_analysis_subgroup_adjusted/{dataset}/DEG_{comparison}.csv
#   - MSigDB gene set definitions (via msigdbr package)
#
# Output:
#   - geneset_mRNA_heatmap/{color_scheme}/{comparison}/{gene_set_name}.tiff
#   - geneset_mRNA_heatmap/{color_scheme}/{comparison}/{gene_set_name}.pdf
#   - geneset_mRNA_heatmap/data/{comparison}/{gene_set_name}.csv
#   - geneset_mRNA_heatmap/data/{comparison}/{gene_set_name}.xlsx
################################################################################
...
# Input directory (DEG results from mRNA_differential_analysis_subgroup_adjusted)
input_dir <- file.path(base_path, "mRNA_differential_analysis_subgroup_adjusted")

# Output directory
output_dir <- file.path(base_path, "geneset_mRNA_heatmap")
...
cat("====================================================================\n")
cat("Gene Set mRNA Polar Heatmap (Circular Heatmap)\n")
cat("====================================================================\n\n")
...
cat("====================================================================\n")
cat("Gene set mRNA polar heatmaps completed!\n")
