################################################################################
# TP53 Phosphoprotein Gene-Level Preranked GSEA (without protein normalization)
#
...
# Input: phosphosite DPS results (without protein normalization)
...
output_dir <- file.path(base_path, "phosphoprotein_without_PN_gene_level_GSEA")
