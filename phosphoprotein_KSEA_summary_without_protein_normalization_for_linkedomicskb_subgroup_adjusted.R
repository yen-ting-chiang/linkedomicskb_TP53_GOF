...
#
# Aggregates the results from the KSEA analysis (phosphoprotein_KSEA_without_protein_normalization_subgroup_adjusted)
#
...
#
# Outputs: .csv and .xlsx files saved into phosphoprotein_KSEA_without_protein_normalization_subgroup_adjusted folder.
################################################################################
...
ksea_dir <- file.path(base_path, "phosphoprotein_KSEA_without_protein_normalization_subgroup_adjusted")
...
cat("====================================================================\n")
cat("TP53 Phosphoprotein KSEA Summarization (LinkedOmicsKB - without protein normalization)\n")
cat("====================================================================\n\n")
