...
#
# Input:  mRNA_GSEA_subgroup_adjusted/
# Output: mRNA_GSEA_meta/
################################################################################
...
gsea_input_dir <- file.path(base_path, "mRNA_GSEA_subgroup_adjusted")

output_dir <- file.path(base_path, "mRNA_GSEA_meta")
...
cat("====================================================================\n")
cat("TP53 mRNA GSEA Cross-Dataset Meta-Analysis\n")
...
cat("\n====================================================================\n")
cat("mRNA GSEA Cross-Dataset Meta-Analysis Complete!\n")
