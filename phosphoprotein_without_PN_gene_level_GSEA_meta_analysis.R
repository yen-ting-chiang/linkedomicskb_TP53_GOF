################################################################################
# TP53 Phosphoprotein (without Protein Normalization) Gene-Level GSEA
...
#      phosphoprotein_without_PN_gene_level_GSEA/{agg_method}/{cancer_type}/{collection}/
...
#
# Input:  phosphoprotein_without_PN_gene_level_GSEA/{max_abs_t, median_t}/
# Output: phosphoprotein_without_PN_gene_level_GSEA_meta/{max_abs_t, median_t}/
################################################################################
...
cat("====================================================================\n")
cat("TP53 Phosphoprotein (without PN) Gene-Level GSEA\n")
...
for (agg_method in agg_methods) {
    ...
    gsea_input_dir <- file.path(base_path, "phosphoprotein_without_PN_gene_level_GSEA",
                                agg_method)
    output_dir <- file.path(base_path, "phosphoprotein_without_PN_gene_level_GSEA_meta",
                            agg_method)
    ...
    cat("\n====================================================================\n")
    cat("Phosphoprotein (without PN) Gene-Level GSEA Meta-Analysis Complete!\n")
    cat("Aggregation method:", agg_method, "\n")
