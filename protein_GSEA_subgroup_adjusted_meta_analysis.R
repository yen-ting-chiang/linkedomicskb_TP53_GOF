...
#
# Input:  protein_GSEA_subgroup_adjusted/
# Output: protein_GSEA_meta/
################################################################################
...
gsea_input_dir <- file.path(base_path, "protein_GSEA_subgroup_adjusted")

output_dir <- file.path(base_path, "protein_GSEA_meta")
...
cat("====================================================================\n")
cat("TP53 protein GSEA Cross-Dataset Meta-Analysis\n")
...
cat("\n====================================================================\n")
cat("protein GSEA Cross-Dataset Meta-Analysis Complete!\n")
