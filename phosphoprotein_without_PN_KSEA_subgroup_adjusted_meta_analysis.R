################################################################################
# TP53 Phosphoprotein KSEA (without Protein Normalization)
...
#      phosphoprotein_KSEA_without_protein_normalization_subgroup_adjusted/
#      {cancer_type}/
...
#
# Input:  phosphoprotein_KSEA_without_protein_normalization_subgroup_adjusted/
# Output: phosphoprotein_KSEA_without_PN_meta/
################################################################################
...
ksea_input_dir <- file.path(base_path, "phosphoprotein_KSEA_without_protein_normalization_subgroup_adjusted")

output_dir <- file.path(base_path, "phosphoprotein_KSEA_without_PN_meta")
...
cat("====================================================================\n")
cat("TP53 Phosphoprotein KSEA (without Protein Normalization)\n")
...
cat("\n====================================================================\n")
cat("Phosphoprotein KSEA (without Protein Normalization)\n")
