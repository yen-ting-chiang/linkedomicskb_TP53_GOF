################################################################################
# TP53 Phosphoprotein GSEA (with Protein Normalization)
...
#      phosphoprotein_GSEA_subgroup_adjusted/
...
#
# Input:  phosphoprotein_GSEA_subgroup_adjusted/
# Output: phosphoprotein_GSEA_with_PN_meta/
################################################################################
...
gsea_input_dir <- file.path(base_path, "phosphoprotein_GSEA_subgroup_adjusted")

output_dir <- file.path(base_path, "phosphoprotein_GSEA_with_PN_meta")
...
cat("====================================================================\n")
cat("TP53 Phosphoprotein GSEA (with Protein Normalization)\n")
...
cat("\n====================================================================\n")
cat("Phosphoprotein GSEA (with Protein Normalization)\n")
