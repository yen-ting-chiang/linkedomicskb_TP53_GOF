################################################################################
# KSEA Phosphosite Polar Heatmap (Circular Heatmap) - with Protein Normalization
#
# Purpose:
...
#
# Output:
#   - KSEA_with_PN_phosphosites_heatmap/{color_scheme}/{comparison}/{kinase_name}.tiff
#   - KSEA_with_PN_phosphosites_heatmap/{color_scheme}/{comparison}/{kinase_name}.pdf
#   - KSEA_with_PN_phosphosites_heatmap/data/{comparison}/{kinase_name}.csv
#   - KSEA_with_PN_phosphosites_heatmap/data/{comparison}/{kinase_name}.xlsx
################################################################################
...
# Input directory (DPS results from phosphoprotein_differential_analysis)
input_dir <- file.path(base_path, "phosphoprotein_differential_analysis_subgroup_adjusted")

# Output directory
output_dir <- file.path(base_path, "KSEA_with_PN_phosphosites_heatmap")
...
selected_datasets <- c("BRCA", "COAD", "GBM", "HNSCC", "LUAD", "UCEC")
...
cat("====================================================================\n")
cat("KSEA Phosphosite Polar Heatmap (with Protein Normalization)\n")
cat("====================================================================\n\n")
