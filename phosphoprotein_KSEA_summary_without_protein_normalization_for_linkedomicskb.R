...
#
# Aggregates the results from the KSEA analysis (phosphoprotein_KSEA_without_protein_normalization)
#
...
#
# Outputs: .csv and .xlsx files saved into phosphoprotein_KSEA_without_protein_normalization folder.
################################################################################
...
ksea_dir <- file.path(base_path, "phosphoprotein_KSEA_without_protein_normalization")
