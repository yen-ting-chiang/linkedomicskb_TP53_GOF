...
#
# Output: mRNA_differential_analysis_subgroup_adjusted/mRNA_DEG_meta_analysis/
################################################################################
...
output_dir <- file.path(deg_dir, "mRNA_DEG_meta_analysis")
...
cat("====================================================================\n")
cat("TP53 mRNA-Level DEG Cross-Cancer Meta-Analysis\n")
...
gsea_output_dir <- file.path(output_dir, "mRNA_meta_GSEA")
