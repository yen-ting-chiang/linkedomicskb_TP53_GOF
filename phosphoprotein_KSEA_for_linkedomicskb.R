...
#
# Uses moderated-t statistics from phosphoprotein_differential_analysis/ as ranking
#
...
dps_dir <- file.path(base_path, "phosphoprotein_differential_analysis")

# Output: KSEA results
output_dir <- file.path(base_path, "phosphoprotein_KSEA")
...
cat("====================================================================\n")
cat("TP53 Phosphoprotein KSEA (KSEAapp - LinkedOmicsKB)\n")
cat("====================================================================\n\n")
