...
#
# Aggregates the results from the KSEA analysis (phosphoprotein_KSEA_subgroup_adjusted)
#
...
#
# Outputs: .csv and .xlsx files saved into phosphoprotein_KSEA_subgroup_adjusted folder.
################################################################################
