...
#
# Outputs: Cross_Dataset_Comparison_Summary_Kinases.csv/xlsx in phosphoprotein_KSEA_without_protein_normalization_subgroup_adjusted/
################################################################################
...
cat("====================================================================\n")
cat("TP53 Phosphoprotein KSEA - Cross-Dataset Comparison Summary (without protein normalization)\n")
cat("====================================================================\n\n")
