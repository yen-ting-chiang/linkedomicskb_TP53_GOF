...
#
# Aggregates the results from the fgsea analysis (phosphoprotein_GSEA_subgroup_adjusted)
#
...
#
# Outputs: .csv and .xlsx files saved into phosphoprotein_GSEA_subgroup_adjusted folder.
################################################################################
...
gsea_dir <- file.path(base_path, "phosphoprotein_GSEA_subgroup_adjusted")
...
cat("====================================================================\n")
cat("TP53 Phosphoprotein GSEA Summarization (LinkedOmicsKB)\n")
cat("====================================================================\n\n")
