...
# (Meta-analysis, without protein normalization)
#
# Purpose:
...
#
# MSigDB collections:
#   Same as phosphoprotein_without_PN_meta_gene_level_ORA.R:
...
cat("(Meta-analysis, without protein normalization)\n")
cat("====================================================================\n\n")
...
# Same MSigDB collections as phosphoprotein_without_PN_meta_gene_level_ORA.R
