...
#
# Output: phosphoprotein_differential_analysis_subgroup_adjusted/phosphoprotein_DPS_meta_analysis/
################################################################################
...
deg_dir <- file.path(base_path, "phosphoprotein_differential_analysis_subgroup_adjusted")

output_dir <- file.path(deg_dir, "phosphoprotein_DPS_meta_analysis")
